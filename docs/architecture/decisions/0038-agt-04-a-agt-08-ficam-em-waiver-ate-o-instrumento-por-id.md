...
`AGT-04` e `AGT-08` ficam em waiver até cada um ganhar
...
**Rule:** `AGT-04`, `AGT-08`. **Scope:** runtime NyCode (`bash`,
subagente). **Owner:** marcioazam.

## Consequências

Positivas: a matriz não mente; o trabalho restante tem dono e data.

Negativas: o produto continua com `bash -c` e envelope de
