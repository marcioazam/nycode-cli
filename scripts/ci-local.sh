#!/usr/bin/env bash
# Baseline local de verificacao do nycode.
#
# O CI remoto acrescenta gates que precisam da base real do PR, da imagem e da
# referencia de paridade. Este script preserva a verificacao reproduzivel que
# cabe na maquina de desenvolvimento.
#
...
#
#   --full   o baseline local ampliado, com cobertura, layout, tamanho de
#            arquivo, release, performance e paridade em modo instrumento.
#            O CI remoto ainda decide os gates que so ele pode medir.
#
