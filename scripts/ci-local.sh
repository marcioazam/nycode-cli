...
full() {
	...
	step "auto-teste do gate do harness de agente" scripts/agent-harness/gate-test.sh
	step "auto-teste do veto do harness de agente" scripts/agent-harness/veto-test.sh
